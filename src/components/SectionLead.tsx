...
const SectionLead = ({
  ...
  return (
    ...
    border-4 border-pink-300 bg-gray-300/30 shadow transition-shadow duration-300 ease-in-out hover:shadow-[0_0_15px_5px_rgba(219,39,119,0.6)] rounded-2xl mask-b-to-black"
    >
<MouseBackground/>      
